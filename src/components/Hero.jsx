    ...
    <section className="relative w-full h-screen mx-auto">
      ...
      >
        <div className="flex flex-col justify-center items-center mt-5">
          <div className="w-5 h-5 rounded-full bg-[#1D4463]" />
          <div className="w-1 sm:h-80 h-40 bg-gradient-to-b from-blue-900 to-transparent" />
        </div>
        <div>
          <h1 className={`${styles.heroHeadText} text-black-100`}>
            Hi, I'm <span className="text-[#1D4463]">Kevin</span>
          </h1>
